...
4. **Configuração do caminho do MARS**:
   - No arquivo `IntegracaoAssembly.cs`, é necessário modificar os locais onde está referenciado o caminho do MARS, substituindo pelo caminho correto do MARS na sua máquina.
